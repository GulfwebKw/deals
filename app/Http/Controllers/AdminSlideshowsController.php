...
class AdminSlideshowsController extends Controller
{
    public $settings;
    public $model;
    public $path;
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:gwc_slideshows,display_order',
    ...
    public function update(Request $request, $id)
    {
        //field validation
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:gwc_slideshows,display_order,' . $id,
            'image' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'title_en' => 'required|string',
            'title_ar' => 'required|string',
            'details_en' => 'required|string',
