...
class AdminAreasController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        $resource->lat = $request->input('lat') ?? 0.0;
        $resource->lng = $request->input('lng') ?? 0.0;
        $resource->city_id = $id;
