...
class AdminUsersAddressController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['listTitle'] =  $this->title . ' List';
    ...
    {
        $resources = $this->model::find($id)->address()->when($request->query('q')!=null , function($query) use($request, $id) { 
    ...
    public function create($id)
    {
        ...
        $this->data['url'] = 'gwc/users/'.$id.'/address';
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect('/gwc/users/' . $id . '/address')->with('message-success', 'A record is added successfully');
    }
    /**
    ...
    public function update(Request $request, $user_id, $id)
    {
        ...
        return redirect('/gwc/users/' . $user_id . '/address')->with('message-success', 'Information is updated successfully');
    }
    /**
