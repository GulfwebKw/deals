...
class AdminTransactionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $resources = $this->model::where('trackid','!=','');
        ...
        if(!empty(Cookie::get('payment_filter_status')) && Cookie::get('payment_filter_status')<>"all"){
            $resources = $resources->where('payment_status','=',Cookie::get('payment_filter_status'));
        }
    ...
    //store transaction filtration values in cookie by ajax
