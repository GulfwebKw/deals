            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    ...
                    <div class="kt-login__signin">
                        ...
                        <form class="kt-form" name="AdmloginForm" id="AdmloginForm" method="POST" action='{{ route("userLogin") }}'>
                            ...
                            <div class="row kt-login__extra">
                                <div class="col">
                                    ...
                                    <a style="color:#FFFFFF;" href="{{url('user/forgot')}}" class="pull-right">{{__('adminMessage.forgot_password')}}?</a>
                                </div>
                            </div>
