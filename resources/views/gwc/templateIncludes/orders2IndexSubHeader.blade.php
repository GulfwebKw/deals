<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            ...
            @if(Request()->input('kt_daterangepicker_range') or Request()->input('ordertype') or Request()->input('q'))
            ...
            <div class="btn-group mx-2">
                <button type="button" class="btn btn-primary btn-bold dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    @if(Request()->input('ordertype')){{strtoupper(Request()->input('ordertype'))}}@else{{strtoupper(__('adminMessage.all'))}}@endif
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    <ul class="kt-nav">
                        <li class="kt-nav__item"><a href="{{request()->fullUrlWithQuery(['ordertype' => 'all'])}}" class="kt-nav__link" id="all">{{__('adminMessage.all')}}</a></li>
                        <li class="kt-nav__item"><a href="{{request()->fullUrlWithQuery(['ordertype' => 'Workshop'])}}" class="kt-nav__link" id="Workshop">Workshop</a></li>
                        <li class="kt-nav__item"><a href="{{request()->fullUrlWithQuery(['ordertype' => 'Service'])}}" class="kt-nav__link" id="Service">Service</a></li>
                    </ul>
                </div>
            </div>
