                ...
                <div class="kt-invoice__container" style="width:100%;">
                    <div class="container-fluid p-4">
                        <div class="text-center">
                            <h3 style="color: white">{{ $order->workshop->name }}</h3>
                            <br>
                            <p style="color: white">{{ $order->workshop->duration_title . '   ' . $order->workshop->duration . ' days' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="kt-invoice__footer">
                <div class="kt-invoice__container" style="width:100%;">
                    <div class="kt-invoice__bank" style="text-align: center;font-size: 20px;padding: 20px">
                        <span>
                            Invoice Generated For : {{ $order->workshop->freelancer->name }}
