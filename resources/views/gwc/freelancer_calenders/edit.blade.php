        ...
        <div class="kt-portlet__body">
            ...
            <div class="col-lg-8">
                <div class="form-group row">
                    <!-- is active? -->
                    <label class="col-3 col-form-label">highlight</label>
                    <div class="col-3">
                                <span class="kt-switch">
                                    <label>
                                        <input type="checkbox" name="highlight" id="highlight" @if($resource->highlight) checked @endif />
                                        <span></span>
                                    </label>
                                </span>
                    </div>
                ...
                <ul class="pic">
                    @foreach(explode(',', $resource->images) as $image)
                        <li data-e="{{$image}}">
                            ...
                            <img width="150" src="{{"/uploads/freelancer_services/". $image}}" alt="">
                        </li>
                    @endforeach
                </ul>
            @endif
