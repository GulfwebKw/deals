						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
                                ...
                                <div class="btn-group">
                                        ...
                                        <a href="javascript:;" data-toggle="modal" data-target="#kt_modal_contact_1" class="btn btn-warning btn-bold"><i class="la la-plus"></i>&nbsp;Send Push notification</a>
                                        @endif
        ...
        <!--begin::Modal-->
							<div class="modal fade" id="kt_modal_contact_1" tabindex="-1" role="dialog" aria-labelledby="kt_modal_contact_1" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">Manage push notification</h5>
											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											</button>
										</div>
										<div class="modal-body">
                          ...
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
											<div class="kt-portlet__body">
                                                ...
                                                <div class="form-group row">
													...
													<label class="col-3 col-form-label">Device of</label>
													<div class="col-3">
														<select class="form-control @if($errors->has('deviceOf')) is-invalid @endif" name="deviceOf">
														<option value="all">{{__('adminMessage.all')}}</option>
														<option value="User">User</option>
														<option value="Freelancer">{{__('adminMessage.freelancer')}}</option>
														<option value="Web">Web</option>
														</select>
														@if($errors->has('deviceOf'))
														<div class="invalid-feedback">{{ $errors->first('deviceOf') }}</div>
														@endif
													</div>
												   </div>
                                                </div>
